...
function setup() {
 ...
 console.log(message)
  ...
  ground = createSprite(width/600*200, height/200*195, width/600*400, height/200*20);
  ...
  invisibleGround = createSprite(width/600*200, height/200*190, width/600*400, height/200*20);
...
function draw() {
  ...
  background("white");
  //exibir pontuação
  text("Pontuação: "+ score, width/600*450, height/200*20);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(width/600*601, height/200*190, width/600*10, height/200*40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width/600*601, height/200*150, width/600*40, height/200*10);
